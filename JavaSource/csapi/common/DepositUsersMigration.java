...
public class DepositUsersMigration {
		...
		String DB_URL = "jdbc:sqlserver://csdb01:1433;databaseName="+args[0];
		 Connection conn = null;
		   ...
		   try{
		      ...
		      String sql1 = "SELECT distinct users_id from ref_users_deposit order by users_id asc";
		      rs = stmt1.executeQuery(sql1);

		      while(rs.next()){
		    	  primaryId=0;
		    	  currentAmnt=0;
		    	  String sql2 = "SELECT ID , LKUP_DEPOSIT_TYPE_ID , AMOUNT from deposit where users_id="+rs.getInt("users_id")+" order by id asc";
