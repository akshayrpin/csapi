...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getActivityType(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getActivityType(map),table);
		 }
	 ...
	 JSONArray configrations = AdminAgent.getLookup("CONFIGURATION_GROUP");
%>
<html>
<head>
	...
	<script>
		$(document).ready(function() {
			...
			<% if(editId>0){%>
				...
				$('#CONFIGURATION_GROUP_ID').val(<%=v.getString("CONFIGURATION_GROUP_ID")%>);
				$('#CONFIGURATION_GROUP_ID').trigger('chosen:updated');				
				
				$('#LKUP_PATTERN_ID').val(<%=v.getString("LKUP_PATTERN_ID")%>);
				$('#LKUP_PATTERN_ID').trigger('chosen:updated');
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<select  name="LKUP_PATTERN_ID" id="LKUP_PATTERN_ID" itype="String" val="" _ent="lso" valrequired="true"><option value=""></option>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="ONLINE" type="checkbox"  <%if(v.getString("ONLINE").equals("Y")){ %>checked <% }%>itype="boolean" ></div></td>
							</tr>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="String" alert="" >
								<select  name="CONFIGURATION_GROUP_ID" id="CONFIGURATION_GROUP_ID" itype="String" val="" _ent="lso" valrequired="false"><option value=""></option>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="AUTO_ISSUE" type="checkbox" itype="boolean" <%if(v.getString("AUTO_ISSUE").equals("Y")){ %>checked <% }%> ></div></td>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="ISDOT" type="checkbox" itype="boolean" <%if(v.getString("ISDOT").equals("Y")){ %>checked <% }%> ></div></td>
								<td class="csui_label" colnum="2" alert="">DOT EXEMPTION</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><div><input name="DOT_EXEMPTION" type="checkbox" itype="boolean" <%if(v.getString("DOT_EXEMPTION").equals("Y")){ %>checked <% }%> ></div></td>
							</tr>
							
							<tr>
								<td class="csui_label" colnum="2" alert="">FINANCE LOCK</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" ><div><input name="FINANCE_LOCK" type="checkbox" itype="boolean" <%if(v.getString("FINANCE_LOCK").equals("Y")){ %>checked <% }%> ></div></td>
								<td class="csui_label" colnum="2" alert="">ISTEMP</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" ><div><input name="ISTEMP" type="checkbox" itype="boolean" <%if(v.getString("ISTEMP").equals("Y")){ %>checked <% }%> ></div></td>
							</tr>
							
							<tr>
								<td class="csui_label" colnum="2" alert="">DURATION MAX</td>
								<td class="csui" colnum="2" type="String" itype="Integer" alert=""><input name="DURATION_MAX" type="text" itype="Integer" value="<%=v.getString("DURATION_MAX") %>" valrequired="false" maxchar="10000"></td>
								<td class="csui_label" colnum="2" alert="">DURATION MAX DAYS</td>
								<td class="csui" colnum="2" type="String" itype="Integer" alert=""><input name="DURATION_MAX_DAYS" type="text" itype="Integer" value="<%=v.getString("DURATION_MAX_DAYS") %>" valrequired="false" maxchar="10000"></td>
							</tr>
							
							<tr>
								<td class="csui_label" colnum="2" alert="">DURATION MAX MONTHS</td>
								<td class="csui" colnum="2" type="String" itype="Integer" alert=""><input name="DURATION_MAX_MONTHS" type="text" itype="Integer" value="<%=v.getString("DURATION_MAX_MONTHS") %>" valrequired="false" maxchar="10000"></td>
								<td class="csui_label" colnum="2" alert="">DURATION MAX YEARS</td>
								<td class="csui" colnum="2" type="String" itype="Integer" alert=""><input name="DURATION_MAX_YEARS" type="text" itype="Integer" value="<%=v.getString("DURATION_MAX_YEARS") %>" valrequired="false" maxchar="10000"></td>
							</tr>
							
							<tr>
								<td class="csui_label" colnum="2" alert="">TEMPLATE</td>
								<td class="csui" colnum="2" type="String" itype="Integer" alert=""><input name="TEMPLATE" type="text" itype="Integer" value="<%=v.getString("TEMPLATE") %>" valrequired="false" maxchar="10000"></td>
								<td class="csui_label" colnum="2" alert="">RENEWAL</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4"><div><input name="RENEWAL" type="checkbox" itype="boolean" <%if(v.getString("RENEWAL").equals("Y")){ %>checked <% }%> ></div></td>
							</tr>
							
							<tr>
								<td class="csui_label" colnum="2" alert="">ENABLE TIME</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="ENABLE_TIME" type="checkbox" itype="boolean" <%if(v.getString("ENABLE_TIME").equals("Y")){ %>checked <% }%> ></div></td>
								<td class="csui_label" colnum="2" alert="">INHERIT</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><div><input name="INHERIT" type="checkbox" itype="boolean" <%if(v.getString("INHERIT").equals("Y")){ %>checked <% }%> ></div></td>
							</tr>
							
	
							<tr>
								<td class="csui_label" colnum="2" alert="">DOT STICKERS</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" >
								<input name="DOT_STICKERS" type="checkbox" itype="boolean" <%if(v.getString("DOT_STICKERS").equals("Y")){ %>checked <% }%> ></td>

								<td class="csui_label" colnum="2" alert="">ISPUBLIC</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="ISPUBLIC" type="checkbox" itype="boolean" <%if(v.getString("ISPUBLIC").equals("Y")){ %>checked <% }%> ></div></td>
								
							</tr>
							
							<tr>
								<td class="csui_label" colnum="2" alert="">BATCH</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" colspan="4">
								<input name="BATCH" type="checkbox" itype="boolean" <%if(v.getString("BATCH").equals("Y")){ %>checked <% }%> ></td>
							</tr>
