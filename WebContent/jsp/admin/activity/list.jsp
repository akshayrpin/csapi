...
<div id="loader"></div>
  ...
  <tr>
	...
	<td class="csui_tools">
	<a href="<%=Config.fullcontexturl()%>/jsp/admin/activity/addmulti.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>" target="lightbox-iframe" loc="<%=Config.fullcontexturl()%>/jsp/admin/activity/addmulti.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>" id="multiedit" title="Multi Edit" border="0"  ><img src="/cs/images/icons/multi-edit.png" border="0"></a>
	</td>
					...
					<table class="csui tablesorter" type="horizontal">
					 <thead>
						<tr>
							...
							<input type="checkbox" name="selectorall" id="selectorall" class="selectorall"></td>
							...
							<td class="csui_header">ISEXEMPTION</td>
							...
							<td class="csui_header">DURATION MAX </td>
							<td class="csui_header">DURATION MAX DAYS</td>
							<td class="csui_header">DURATION MAX MONTHS</td>
							<td class="csui_header">DURATION MAX YEARS</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<td class="csui"><%=r.getString("TYPE") %></td>
								<td class="csui"><%=r.getString("DESCRIPTION") %></td>
								<td class="csui"><%=r.getString("ISPUBLIC") %></td>
								<td class="csui"><%=r.getString("ONLINE") %></td>
								
								<td class="csui"><%=r.getString("ISDOT") %></td>
								<td class="csui"><%=r.getString("DOT_EXEMPTION") %></td>
								<td class="csui"><%=r.getString("MAX_ALLOWED") %></td>
								<td class="csui"><%=r.getString("MAX_ACTIVE_APPOINTMENTS") %></td>
								<td class="csui"><%=r.getString("MONTH_START") %></td>
								<td class="csui"><%=r.getString("DAY_START") %></td>
								<td class="csui"><%=r.getString("YEARS_TILL_EXPIRED") %></td>
								<td class="csui"><%=r.getString("DAYS_TILL_EXPIRED") %></td>
								<td class="csui"><%=r.getString("DURATION_MAX") %></td>
								<td class="csui"><%=r.getString("DURATION_MAX_DAYS") %></td>
								<td class="csui"><%=r.getString("DURATION_MAX_MONTHS") %></td>
								<td class="csui"><%=r.getString("DURATION_MAX_YEARS") %></td>
								
								<td class="csui" width="1%">
								<a title="Task <%=r.getString("TYPE") %>" target="lightbox-iframe" href="../../tasks/task.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>&ID=<%=r.getString("ID") %>&process=task" ><img src="/cs/images/icons/controls/white/task.png" border="0"></a>
								</td>
								
								<td class="csui" width="1%">
								<a title="Edit <%=r.getString("TYPE") %>" target="lightbox-iframe" href="add.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>&ID=<%=r.getString("ID") %>&process=edit" ><img src="/cs/images/icons/controls/black/edit.png" border="0"></a>
								</td>
								<td class="csui" width="1%">
								<a title="Delete <%=r.getString("TYPE") %>"href="javascript:void(0);" target="" onclick="deletetype(<%=r.getString("ID") %>);" ><img src="/cs/images/icons/controls/black/delete.png" border="0"></a>
								</td>
							</tr>
						<%} %>
						</tbody>
