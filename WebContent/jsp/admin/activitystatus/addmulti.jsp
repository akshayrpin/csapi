...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
			 MapSet ms = AdminMap.getActivityStatusMulti(map);
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<select  name="LIVE" id="LIVE" itype="String" val="" _ent="lso" valrequired="false" >
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" >
								<select  name="EXPIRED" id="EXPIRED" itype="String" val="" _ent="lso" valrequired="false" >
										<option value="">Please Select</option>
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" >
								<select  name="ISSUED" id="ISSUED" itype="String" val="" _ent="lso" valrequired="false" >
										<option value="">Please Select</option>
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" >
								<select  name="INHERIT" id="INHERIT" itype="String" val="" _ent="lso" valrequired="false" >
										<option value="">Please Select</option>
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" >
								<select  name="ISPUBLIC" id="ISPUBLIC" itype="String" val="" _ent="lso" valrequired="false" >
										<option value="">Please Select</option>
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" >
								<select  name="DEFLT" id="DEFLT" itype="String" val="" _ent="lso" valrequired="false" >
										<option value="">Please Select</option>
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" >
								<select  name="ONLINE_PRINT" id="ONLINE_PRINT" itype="String" val="" _ent="lso" valrequired="false" >
										<option value="">Please Select</option>
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" >
								<select  name="ISDOT" id="ISDOT" itype="String" val="" _ent="lso" valrequired="false" >
										<option value="">Please Select</option>
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
							...
							<tr>
								...
								<select  name="FINAL" id="FINAL" itype="String" val="" _ent="lso" valrequired="false" >
										<option value="">Please Select</option>
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
