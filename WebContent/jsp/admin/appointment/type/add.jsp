...
<%
	...
	String table = Table.LKUPAPPOINTMENTTYPETABLE;
	String alert="";
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getAppointmentType(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getAppointmentType(map),table);
		 }
	 ...
	 JSONArray av = AdminAgent.getLookup("AVAILABILITY");
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">APPOINTMENT TYPE</td>
				...
				<form id="csform" class="form" ajax="no" action="add.jsp" method="post">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">APPOINTMENT TYPE</td>
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert="" colspan="4">
									...
									<%for(int i=0;i<av.length();i++){ %>	<option value="<%=av.getJSONObject(i).getInt("ID")%>"><%=av.getJSONObject(i).getString("TEXT")%></option>		<%}%>
								</select>
								</td>
							</tr>
