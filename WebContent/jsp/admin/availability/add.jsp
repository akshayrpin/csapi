...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getAvailability(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getAvailability(map),table);
		 }
	 ...
	 JSONArray types = AdminAgent.getLookup("LKUP_HOLIDAY_TYPE");
...
<head>
	...
	<script>
		$(document).ready(function() {
			...
			$('#LKUP_HOLIDAY_TYPE_ID').val(<%=v.getString("LKUP_HOLIDAY_TYPE_ID")%>);
			$('#LKUP_HOLIDAY_TYPE_ID').trigger('chosen:updated');
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">AVAILABILITY </td>
				...
				<form id="csform" action="add.jsp" method="post">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">AVAILABILITY </td>
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<td class="csui_label" colnum="2" alert="">PRESCHEDULE DAYS</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="PRESCHEDULE_DAYS" type="text" itype="text" value="<%=v.getString("PRESCHEDULE_DAYS") %>" valrequired="true" maxchar="10000"></td>
							</tr>
							<tr>
								<td class="csui_label" colnum="2" alert="">HOLIDAY</td>
								<td class="csui" colnum="2" type="String" itype="String" alert="" colspan="4">
								<select  name="LKUP_HOLIDAY_TYPE_ID" id="LKUP_HOLIDAY_TYPE_ID" itype="String" val="" _ent="lso" valrequired="true" ><option value=""></option>
