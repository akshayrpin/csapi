...
<%
	...
	if(editId>0){
		...
		fields = AdminAgent.getList(AdminMap.getAvailabilityCustom(editId));
	}
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">CUSTOM SETTINGS - <%=v.getString("TITLE") %></td>
				...
				<table class="csui_title">
						<tr>
							...
							<td class="csui_title">
								<a target="lightbox-iframe" href="field/addcustom.jsp?_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>&_groupid=<%=editId%>&_groupname=<%=v.getString("GROUP_NAME") %>" ><img src="/cs/images/icons/controls/white/add.png" border="0"></a>
							</td>
				...
				<table class="csui tablesorter" type="horizontal">
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<td class="csui" style="cursor:pointer;" rel="<%=r.getString("ID") %>" ><%=r.getString("CUSTOM_DATE") %>
								...
								<td class="csui" width="1%">
									<a target="lightbox-iframe" href="field/addcustom.jsp?_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>&ID=<%=r.getString("ID") %>&_groupid=<%=editId%>&_groupname=<%=v.getString("GROUP_NAME") %>&process=edit" ><img src="/cs/images/icons/controls/black/edit.png" border="0"></a>
								</td>
								<td class="csui" width="1%">
