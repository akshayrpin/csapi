...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 ...
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getAvailabilityDefault(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getAvailabilityDefault(map),table);
		 }
	...
	<script>
		$(document).ready(function() {
			...
			<% if(editId>0){%>
				...
				$('#DAY_OF_WEEK').val(<%=v.getString("DAY_OF_WEEK")%>);
				$('#DAY_OF_WEEK').trigger('chosen:updated');
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">DEFAULT </td>
						<td align="right" id="subtitle">&nbsp;</td>
					</tr>
				</table>
				
				<div id="csform_message"></div>
				<form id="csform" class="form" ajax="no" action="adddefault.jsp" method="post">
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								<td class="csui_label" colnum="2" alert="">DAY OF WEEK</td>
								<td class="csui" colnum="2" type="String" itype="String" alert="">
								<select  name="DAY_OF_WEEK" id="DAY_OF_WEEK" itype="String" val="" _ent="lso" valrequired="true"><option value=""></option>
							...
							<tr>
								...
								<td class="csui_label" colnum="2" alert="">BUFFER HOURS</td>
