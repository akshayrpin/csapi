...
<%
	...
	System.out.println(groupName+"%%%%%CAME HEREEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE%%");
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getHoliday(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getHoliday(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">HOLIDAY TYPE </td>
						<td align="right" id="subtitle"><%= groupName%></td>
					</tr>
				</table>
				...
				<form id="csform" class="form" ajax="no" action="add.jsp" method="post">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">HOLIDAY</td>
							<td class="csui_controls"></td>
						</tr>
					</table>
						<input name="LKUP_HOLIDAY_TYPE_ID" type="hidden" value="<%= groupId%>" >
						<table class="csui" colnum="2" type="default">
							
							<tr>
								<td class="csui_label" colnum="2" alert="">HOLIDAY</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="HOLIDAY" type="text" itype="text" value="<%=v.getString("HOLIDAY") %>" valrequired="true" maxchar="10000"></td>
							
							</tr>
							<tr>
								<td class="csui_label" colnum="2" alert="">MESSAGE</td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" ><input name="MESSAGE" type="text" itype="text" value="<%=v.getString("MESSAGE") %>" valrequired="false" maxchar="10000"></td>
							</tr>
							<tr>
								<td class="csui_label" colnum="2" alert="">HOLIDAY DATE</td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" ><input name="HOLIDAY_DATE" type="text" itype="date" value="<%=v.getString("HOLIDAY_DATE") %>" valrequired="true" maxchar="10000"></td>
							</tr>
					</table>
