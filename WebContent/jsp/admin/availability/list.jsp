	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<br/><br/>
				...
				<input type="hidden" name="SEARCH_FIELDS" value="TITLE">
					...
					<table class="csui tablesorter" type="horizontal">
					 <thead>
						<tr>
							...
							<td class="csui_header">PRESCHEDULE DAYS</td>
							<td class="csui_header">CUSTOM SEATS</td>
							<td class="csui_header">DEFAULT</td>
							<td class="csui_header">CUSTOM</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<td class="csui"><%=r.getString("PRESCHEDULE_DAYS") %></td>
								<td class="csui" width="1%">
								<a target="lightbox-iframe" href="slist.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>&ID=<%=r.getString("ID") %>&process=edit" ><img src="/cs/images/icons/controls/black/briefcase.png" border="0"></a>
								</td>
								<td class="csui" width="1%">
								<a target="lightbox-iframe" href="dlist.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>&ID=<%=r.getString("ID") %>&process=edit" ><img src="/cs/images/icons/controls/black/briefcase.png" border="0"></a>
								</td>
								<td class="csui" width="1%">
								<a target="lightbox-iframe" href="clist.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>&ID=<%=r.getString("ID") %>&process=edit" ><img src="/cs/images/icons/controls/black/briefcase.png" border="0"></a>
								</td>
