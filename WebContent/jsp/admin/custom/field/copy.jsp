...
<%
	...
	//String updateTable=Table.ACTIVITYTABLE;
	String alert="";
	 JSONArray astatus = AdminAgent.getLookup(table);
	...
	if(map.equalsIgnoreCase("_action","COPY")){
		 ...
		 MapSet ms = AdminMap.copyField(map);
		 result = AdminAgent.copyField(ms,table);
	 }
	 ...
	 JSONArray groupNames = AdminAgent.getLookup("FIELD_GROUPS");
%>
<html>
<head>
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">COPY CUSTOM FIELD</td>
						<td align="right" id="subtitle">&nbsp;</td>
					</tr>
				</table>
				
				<div id="csform_message"></div>
				<form id="csform" class="form" ajax="no" action="copy.jsp" method="post">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">COPY CUSTOM FIELD</td>
						...
						<table class="csui" colnum="2" type="default">
							<tr>
						     	<td class="csui_label" colnum="2" alert="">FIELD GROUPS</td>
								<td class="csui" colnum="2" type="String" itype="String" alert="" >
								<select  name="GROUP_ID" id="GROUP_ID" itype="String" val="" _ent="lso" valrequired="true" ><option value=""></option>
									<%for(int i=0;i<groupNames.length();i++){ 
								
									
									%>	<option value="<%=groupNames.getJSONObject(i).getInt("ID")%>"><%=groupNames.getJSONObject(i).getString("TEXT")%></option>		<%}%>
			...
			<div class="csui_buttons">
				...
				<input type="submit" name="_action" value="copy" class="csui_button">
			</div>
				</form>
			</div>
		</div>
