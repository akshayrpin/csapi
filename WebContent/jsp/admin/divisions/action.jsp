...
<%
	...
	if(Operator.equalsIgnoreCase(action, "showselector")){
		...
		int groupid = map.getInt("LKUP_DIVISIONS_TYPE_ID");
		
		if(groupid>0){
			
			JSONArray o = AdminAgent.getJsonList(AdminMap.getDivisionsFields(groupid));
			//o.put(1,);
	...
	if(Operator.equalsIgnoreCase(action, "addref")){
		...
		int groupid = map.getInt("LKUP_DIVISIONS_ID");
