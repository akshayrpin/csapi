...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getDivisionsFieldType(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getDivisionsFieldType(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">DIVISIONS TYPE </td>
				...
				<form id="csform" class="form" ajax="no" action="add.jsp" method="post">
					...
					<table class="csui_title">
						...
						<input name="LKUP_DIVISIONS_TYPE_ID" type="hidden" value="<%= groupId%>" >
						<table class="csui" colnum="2" type="default">
							
							<tr>
								<td class="csui_label" colnum="2" alert="">DIVISION</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="DIVISION" type="text" itype="text" value="<%=v.getString("DIVISION") %>" valrequired="true" maxchar="10000"></td>
							...
							<tr>
								<td class="csui_label" colnum="2" alert="">INFO</td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" ><textarea name="INFO" rows="20" cols="5" ><%=v.getString("INFO") %></textarea></td>
							</tr>
					</table>
