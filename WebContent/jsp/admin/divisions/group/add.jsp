...
<%
	...
	String table = Table.LKUPDIVISIONSGROUPTABLE;
	String alert="";
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getDivisionsGroup(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getDivisionsGroup(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">DIVISION GROUP</td>
				...
				<form id="csform" action="add.jsp" method="post" class="form"  ajax="no" >
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">DIVISION GROUP</td>
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="GROUP_NAME" type="text" itype="text" value="<%=v.getString("GROUP_NAME") %>" valrequired="true" maxchar="10000"></td>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="DEFLT" type="checkbox" itype="boolean" <%if(v.getString("DEFLT").equals("Y")){ %>checked <% }%> ></div></td>
