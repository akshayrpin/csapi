...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 MapSet m = AdminMap.getFeeMap(map);
			//History
			 String qsh = "insert into FINANCE_MAP_HISTORY select * from FINANCE_MAP where ID = "+m.getInt("ID");
			 result = AdminAgent.saveType(qsh);
			 
			 result = AdminAgent.updateType(m,table);
			 
		 }else {
			 result = AdminAgent.saveType(AdminMap.getFeeMap(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">MAP ACCOUNT</td>
				...
				<form id="csform" action="add.jsp" method="post">
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								<td class="csui_label" colnum="2" alert="">KEY_CODE</td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" ><input name="KEY_CODE" type="text" itype="text" value="<%=v.getString("KEY_CODE") %>" valrequired="true" maxchar="10000"></td>
								<td class="csui_label" colnum="2" alert="">ORG CODE</td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" ><input name="BUDGET_UNIT" type="text" itype="text" value="<%=v.getString("BUDGET_UNIT") %>" valrequired="true" maxchar="10000"></td>
							</tr>
							<tr>
								<td class="csui_label" colnum="2" alert="">OBJ CODE</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="ACCOUNT_NUMBER" type="text" itype="text" value="<%=v.getString("ACCOUNT_NUMBER") %>" valrequired="true" maxchar="10000"></td>
								<td class="csui_label" colnum="2" alert="">FUND</td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" ><input name="FUND" type="text" itype="text" value="<%=v.getString("FUND") %>" valrequired="true" maxchar="10000"></td>
							</tr>
