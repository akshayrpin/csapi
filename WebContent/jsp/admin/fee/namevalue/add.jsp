...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 MapSet e = AdminMap.getFeeNameValue(map);	
		 ...
		 if(editId>0){
			...
			//	 System.out.println(result+"initial update");
				 if(result){
					 ...
					 e.remove("START_DATE");
					 e.add("START_DATE", e.getString("NEW_START_DATE"));
		...
		$(document).ready(function() {
			...
			<% if(result){%>
				...
				<% if(editId>0){%>
				 ...
				 var d = new Date();  
					var tomo = new Date("<%=v.getString("START_DATE")%>");
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">FEE NAME</td>
				...
				<form id="csform" class="form" ajax="no" action="add.jsp" method="post">
					...
					<input type="hidden" name="SUM_NAMES" value="N">
					
					<table class="csui_title">
						<tr>
							<td class="csui_title">FEE NAME</td>
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert="" colspan="4"><input name="VALUE" type="text" itype="decimal" value="<%=v.getString("VALUE") %>" valrequired="true" maxchar="10000"></td>
			...
			<div class="csui_buttons">
				...
				<%if(editId>0 && !Operator.hasValue(v.getString("EXPIRATION_DATE"))){ %>
