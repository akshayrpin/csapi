...
<%
	...
	String sortfield= map.getString("SORT_FIELD","METHOD_TYPE");
	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<br/><br/>
				...
				<input type="hidden" name="SEARCH_FIELDS" value="METHOD_TYPE">
					...
					<table class="csui tablesorter" type="horizontal">
					 <thead>
						<tr>
							...
							<td class="csui_header">PAYMENT_MODE</td>
							<td class="csui_header">REVERSE_MODE</td>
							<td class="csui_header">APPLY_DEPOSIT</td>
							<td class="csui_header">RECORD_FINANCIALS</td>
							<td class="csui_header">CASH</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<td class="csui" style="cursor:pointer;" rel="<%=r.getString("ID") %>" ><%=r.getString("METHOD_TYPE") %>
								 <input type="hidden" id="refname_<%=r.getString("ID") %>" name="refname_<%=r.getString("ID") %>" value="<%=r.getString("METHOD_TYPE") %>">
								 
								</td>
								<td class="csui"><%=r.getString("PAYMENT_MODE") %></td>
								<td class="csui"><%=r.getString("REVERSE_MODE") %></td>
								<td class="csui"><%=r.getString("APPLY_DEPOSIT") %></td>
								<td class="csui"><%=r.getString("RECORD_FINANCIALS") %></td>
								<td class="csui"><%=r.getString("CASH_FLAG") %></td>
