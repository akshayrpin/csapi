...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getPaymentTransaction(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getPaymentTransaction(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">PAYMENT TRANSACTION</td>
				...
				<form id="csform" class="form" ajax="no" action="add.jsp" method="post"  enctype="multipart/form-data">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">PAYMENT TRANSACTION</td>
