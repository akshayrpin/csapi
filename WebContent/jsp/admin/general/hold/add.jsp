...
<%
	...
	String table = Table.LKUPHOLDTYPETABLE;
	String alert="";
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getHoldsType(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getHoldsType(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">HOLD TYPE</td>
				...
				<form id="csform" action="add.jsp" method="post" class="form"  ajax="no" >
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">HOLD TYPE</td>
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<td class="csui_label" colnum="2" alert="">SIGNIFICANT</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="SIGNIFICANT" type="checkbox" itype="boolean" <%if(v.getString("SIGNIFICANT").equals("Y")){ %>checked <% }%> ></div></td>
							</tr>
