	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<br/><br/>
				...
				<input type="hidden" name="SEARCH_FIELDS" value="GROUP_NAME,DESCRIPTION">
						...
						<tr>
							<td class="csui">
								...
								%>
									...
									<table class="csui" type="horizontal" id="cr_<%=r.getString("LIBRARY_GROUP_ID")%>" style="cursor:pointer;" title="Drag to sort">
										<tr>
											<td class="csui" width="1%">
												<img src="/cs/images/icons/controls/black/delete.png" border="0" onclick="deleteref(<%=r.getString("LIBRARY_GROUP_ID") %>);" >
											</td>
											<td class="csui">
