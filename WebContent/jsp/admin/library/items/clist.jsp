...
<%
	...
	String libraryId = map.getString("libraryId","0");
	...
	if(connector){
	 ...
	 a = AdminAgent.getAssociateLibraryGroups(Operator.toInt(ID));
		...
		<div id="csuisub">
				...
				<table class="csuisub_title sticky " alert="warning"  cellpadding="20" cellspacing="0" border="0" type="horizontal" >
						<tr>
							...
							<input type="submit" id="copy" name="copy" value="ASSOCIATE" class="connectors" >
							</td>
						</tr>
