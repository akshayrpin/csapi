	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			...
			// map.remove("CREATED_IP");
			// map.remove("CREATED_BY");
			// map.remove("UPDATED_DATE");
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<select  name="LKUP_LSO_TYPE_ID" id="LKUP_LSO_TYPE_ID" itype="String" val="" _ent="lso" valrequired="true" ><option value=""></option>
									<%for(int i=0;i<lsoTypes.length();i++){ %>	<option value="<%=lsoTypes.getJSONObject(i).getInt("ID")%>"><%=lsoTypes.getJSONObject(i).getString("TEXT")%></option><%}%>
								</select>
								</td>
								<td class="csui_label" colnum="2" alert="">RANGE</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<div><input name="RANGE" type="checkbox"  <%if(v.getString("RANGE").equals("Y")){ %>checked <% }%>itype="boolean" ></div>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<select  name="LSO_STREET_ID" id="LSO_STREET_ID" itype="String" val="" _ent="lso" valrequired="true" ><option value=""></option>
							...
							<tr>
								<td class="csui_label" colnum="2" alert="">STREET MODE</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<input name="STR_MOD" type="text" itype="text" value="<%=v.getString("STR_MOD") %>" valrequired="true" maxchar="10000">
								</td>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<input name="UNIT" type="text" itype="text" value="<%=v.getString("UNIT") %>" valrequired="true" maxchar="10000">
								</td>
								<td class="csui_label" colnum="2" alert="">CITY</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<input name="CITY" type="text" itype="text" value="<%=v.getString("CITY") %>" valrequired="true" maxchar="10000">
								</td>
							</tr>
							<tr>
								<td class="csui_label" colnum="2" alert="">STATE</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<input name="STATE" type="text" itype="text" value="<%=v.getString("STATE") %>" valrequired="true" maxchar="10000">
								</td>
								<td class="csui_label" colnum="2" alert="">ACTIVE</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<div><input name="ACTIVE" type="checkbox"  <%if(v.getString("ACTIVE").equals("Y")){ %>checked <% }%>itype="boolean" ></div>
								</td>
							</tr>
							<tr>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<input name="ZIP4" type="text" itype="text" value="<%=v.getString("ZIP4") %>" valrequired="true" maxchar="10000">
								</td>
							</tr>
					</table>
