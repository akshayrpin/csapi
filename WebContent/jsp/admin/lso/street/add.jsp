...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getLSOStreetMap(map),table);   
		 }else {
			 result = AdminAgent.saveType(AdminMap.getLSOStreetMap(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">LSO STREET</td>
				...
				<form id="csform" action="add.jsp" method="post">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">LSO STREET</td>
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								<td class="csui_label" colnum="2" alert="">PRE DIRECTORY</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<input name="PRE_DIR" type="text" itype="text" value="<%=v.getString("PRE_DIR") %>" valrequired="true" maxchar="10000">
								</td>
								<td class="csui_label" colnum="2" alert="">STREET  NAME</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<input name="STR_NAME" type="text" itype="text" value="<%=v.getString("STR_NAME") %>" valrequired="true" maxchar="10000">
								</td>
							</tr>
							<tr>
								<td class="csui_label" colnum="2" alert="">STREET TYPE</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<input name="STR_TYPE" type="text" itype="text" value="<%=v.getString("STR_TYPE") %>" valrequired="true" maxchar="10000">
								</td>
								<td class="csui_label" colnum="2" alert="">SUFFIX DIRECTION</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4">
								<input name="SUF_DIR" type="text" itype="text" value="<%=v.getString("SUF_DIR") %>" valrequired="true" maxchar="10000">
								</td>
							</tr>
							<tr>
