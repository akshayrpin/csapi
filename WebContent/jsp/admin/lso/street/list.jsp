...
<%
	...
	String table = Table.LSOSTREETTABLE;
	...
	String sortfield= map.getString("SORT_FIELD","STR_NAME");
	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<br/><br/>
				...
				<input type="hidden" name="SEARCH_FIELDS" value="STR_NAME">
				...
				<div class="csui_divider"></div>
				   ...
				   <table class="csui_title" alert="warning">
						...
						<tr>
							...
							-->
							<td class="csui_header">PRE DIR</td>
							<td class="csui_header">STREET NAME</td>
							<td class="csui_header">STREET TYPE</td>
							<td class="csui_header">SUF DIR</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<%} %>
								<td class="csui" style="cursor:pointer;" rel="<%=r.getString("ID") %>" ><%=r.getString("PRE_DIR") %>
								 <input type="hidden" id="refname_<%=r.getString("ID") %>" name="refname_<%=r.getString("ID") %>" value="<%=r.getString("MODULE") %>">
								</td>
								<td class="csui"  style="cursor:pointer;" rel="<%=r.getString("ID") %>" ><%=r.getString("STR_NAME") %></td>
								<td class="csui"  style="cursor:pointer;" rel="<%=r.getString("ID") %>" ><%=r.getString("STR_TYPE") %></td>
								<td class="csui"  style="cursor:pointer;" rel="<%=r.getString("ID") %>" ><%=r.getString("SUF_DIR") %></td>
