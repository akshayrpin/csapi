					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<input name="MODULE" type="hidden" itype="text" value="<%=v.getString("MODULE") %>" ></td>
							</tr>
							<tr>
								<td class="csui_label" colnum="2" alert="">DISABLE ON HOLD</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="DISABLE_ON_HOLD" type="checkbox" itype="boolean" <%if(v.getString("DISABLE_ON_HOLD").equals("Y")){ %>checked <% }%> ></div></td>
								<td class="csui_label" colnum="2" alert="">DISABLE TOOL ON HOLD</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="DISABLE_TOOL_ON_HOLD" type="checkbox" itype="boolean" <%if(v.getString("DISABLE_TOOL_ON_HOLD").equals("Y")){ %>checked <% }%> ></div></td>
