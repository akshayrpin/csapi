...
<%
	...
	String sortfield= map.getString("SORT_FIELD","MODULE");
	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<br/><br/>
				...
				<input type="hidden" name="SEARCH_FIELDS" value="MODULE">
				...
				<div class="csui_divider"></div>
				   ...
				   <table class="csui_title" alert="warning">
						...
						<tr>
							...
							<td class="csui_header">DISABLE ON HOLD</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<%} %>
								<td class="csui" style="cursor:pointer;" rel="<%=r.getString("ID") %>" ><%=r.getString("MODULE") %>
								 <input type="hidden" id="refname_<%=r.getString("ID") %>" name="refname_<%=r.getString("ID") %>" value="<%=r.getString("MODULE") %>">
								 
								</td>
								<td class="csui"  style="cursor:pointer;" rel="<%=r.getString("ID") %>" ><%=r.getString("DISABLE_ON_HOLD") %></td>
