...
<%
	...
	String table = Table.LKUPPROJECTTYPETABLE;
	String alert="";
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getProjectType(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getProjectType(map),table);
		 }
	...
	<script>
		$(document).ready(function() {
			...
			<% if(editId>0){%>
				...
				$('#PATTERN_ID').val(<%=v.getString("PATTERN_ID")%>);
				$('#PATTERN_ID').trigger('chosen:updated');
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">PROJECT TYPE</td>
				...
				<form id="csform" class="form" ajax="no" action="add.jsp" method="post">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">PROJECT TYPE</td>
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<td class="csui_label" colnum="2" alert="">EXPIRES</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="EXPIRES" type="checkbox" itype="boolean" <%if(v.getString("EXPIRES").equals("Y")){ %>checked <% }%> ></div></td>
							</tr>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="MAX_ACTIVE_APPOINTMENTS" type="text" itype="String" value="<%=v.getString("MAX_ACTIVE_APPOINTMENTS") %>" valrequired="true" maxchar="10000"></td>
							</tr>
							
						    <tr>
                                <td class="csui_label" colnum="2" alert="">MAX CHILD APPOINTMENTS</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="MAX_CHILD_APPOINTMENTS" type="text" itype="String" value="<%=v.getString("MAX_CHILD_APPOINTMENTS") %>" valrequired="true" maxchar="10000"></td>
								<td class="csui_label" colnum="2" alert="">MAX CHILD APPOINTMENTS DAY</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="MAX_CHILD_APPOINTMENTS_DAY" type="text" itype="String" value="<%=v.getString("MAX_CHILD_APPOINTMENTS_DAY") %>" valrequired="true" maxchar="10000"></td>
							</tr>
							<tr>
								<td class="csui_label" colnum="2" alert="">ISPUBLIC</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" colspan="4"><div><input name="ISPUBLIC" type="checkbox" itype="boolean" <%if(v.getString("ISPUBLIC").equals("Y")){ %>checked <% }%> ></div></td>
						    </tr>
