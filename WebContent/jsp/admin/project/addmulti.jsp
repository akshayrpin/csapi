...
<%
	...
	if(map.equalsIgnoreCase("_action","SAVE")){
		     MapSet ms = AdminMap.getProjectTypeMulti(map);
...
<div id="csuibody">
		<div id="csuimain">
			...
			<div class="csuicontent">
				...
				<form id="csform" class="form" ajax="no" action="addmulti.jsp" method="post">
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" >
								<select  name="EXPIRES" id="EXPIRES" itype="String" val="" _ent="lso" valrequired="true" >
										<option value="">Please Select</option>
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
						   ...
						   <tr>
							...
							<tr>
								...
								<select  name="AVAILABILITY_ID" id="AVAILABILITY_ID" itype="String" val="" _ent="lso" ><option value=""></option>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="MAX_ACTIVE_APPOINTMENTS" type="text" itype="String" value="<%=v.getString("MAX_ACTIVE_APPOINTMENTS") %>" maxchar="10000"></td>
							</tr>
							
						    <tr>
                                <td class="csui_label" colnum="2" alert="">MAX CHILD APPOINTMENTS</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="MAX_CHILD_APPOINTMENTS" type="text" itype="String" value="<%=v.getString("MAX_CHILD_APPOINTMENTS") %>" maxchar="10000"></td>
								<td class="csui_label" colnum="2" alert="">MAX CHILD APPOINTMENTS DAY</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="MAX_CHILD_APPOINTMENTS_DAY" type="text" itype="String" value="<%=v.getString("MAX_CHILD_APPOINTMENTS_DAY") %>" maxchar="10000"></td>
							</tr>
					</table>
