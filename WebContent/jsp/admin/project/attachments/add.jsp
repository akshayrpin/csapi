...
<%
	...
	String table = Table.LKUPATTACHTYPETABLE;
	String alert="";
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getAttachments(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getAttachments(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">ATTACHMENTS</td>
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="TYPE" type="text" itype="text" value="<%=v.getString("TYPE") %>" valrequired="true" maxlength="75"></td>
								<td class="csui_label" colnum="2" alert="">DESCRIPTION</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="DESCRIPTION" type="text" itype="text" value="<%=v.getString("DESCRIPTION") %>" valrequired="false" maxlength="250"></td>
							</tr>
							
							<tr>
								<td class="csui_label" colnum="2" alert="">SENSITIVE</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="SENSITIVE" type="checkbox"  <%if(v.getString("SENSITIVE").equals("Y")){ %>checked <% }%>itype="boolean" ></div></td>
