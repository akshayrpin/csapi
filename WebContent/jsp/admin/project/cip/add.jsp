...
<%
	...
	String table = Table.LKUPCIPTABLE;
	String alert="";
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getCIP(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getCIP(map),table);
		 }
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<td class="csui_label" colnum="2" alert="">CIP ACCOUNT NUMBER</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="CIP_ACCTNO" type="text" itype="text" value="<%=v.getString("CIP_ACCTNO") %>" valrequired="true" maxchar="10000"></td>
							</tr>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="date" itype="date" alert="">
									...
									<input id="START_DATE" name="START_DATE" type="text" itype="date" value="<%=v.getString("START_DATE") %>" valrequired="true" maxchar="10000">
								
								</td>
								
								<td class="csui_label" colnum="2" alert="">END DATE</td>
								<td class="csui" colnum="2" type="date" itype="date" alert="">

									<input id="END_DATE" name="END_DATE" type="text" itype="date" value="<%=v.getString("END_DATE") %>" valrequired="true" maxchar="10000">
