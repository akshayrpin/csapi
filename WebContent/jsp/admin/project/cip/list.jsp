...
<%
	...
	String sortfield= map.getString("SORT_FIELD","CIP_ACCTNO");
	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<br/><br/>
				...
				<input type="hidden" name="SEARCH_FIELDS" value="NAME,CIP_ACCTNO">
					...
					<table class="csui tablesorter" type="horizontal">
					 <thead>
						<tr>
							...
							-->
							<td class="csui_header">CIP ACCOUNT NUMBER</td>
							<td class="csui_header">NAME</td>
							<td class="csui_header">START DATE</td>
							<td class="csui_header">EXPIRED DATE</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<td class="csui"><%=r.getString("CIP_ACCTNO") %></td>
								<td class="csui"><%=r.getString("NAME") %></td>
								<td class="csui"><%=r.getString("START_DATE") %></td>
								<td class="csui"><%=r.getString("END_DATE") %></td>
