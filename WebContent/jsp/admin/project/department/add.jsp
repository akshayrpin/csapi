...
<%
	...
	String table = Table.DEPARTMENTTABLE;
	String alert="";
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getDepartment(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getDepartment(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">DEPARTMENT</td>
				...
				<form id="csform" class="form" ajax="no"  action="add.jsp" method="post">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">DEPARTMENT</td>
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="DEPT" type="text" itype="text" value="<%=v.getString("DEPT") %>" valrequired="true" maxlength="75"></td>
							...
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert="" colspan="4"><input name="CODE" type="text" itype="text" value="<%=v.getString("CODE") %>" maxlength="5" valrequired="true" ></td>
