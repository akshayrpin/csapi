...
<%
	...
	String sortfield= map.getString("SORT_FIELD","DEPT");
	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<br/><br/>
				...
				<input type="hidden" name="SEARCH_FIELDS" value="DEPARTMENT,DESCRIPTION">
					...
					<table class="csui tablesorter" type="horizontal">
					 <thead>
						<tr>
							...
							-->
							<td class="csui_header">DEPARTMENT</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<td class="csui"><%=r.getString("CODE") %></td>
