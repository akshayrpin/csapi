...
<td class="csui_tools">
  <a href="<%=Config.fullcontexturl()%>/jsp/admin/project/addmulti.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>" target="lightbox-iframe" loc="<%=Config.fullcontexturl()%>/jsp/admin/project/addmulti.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>" id="multiedit" title="Multi Edit" border="0"  ><img src="/cs/images/icons/multi-edit.png" border="0"></a>
</td>
  </tr>
</table>
</td>
					...
					<table class="csui tablesorter" type="horizontal">
					 <thead>
						<tr>
							...
							<td class="csui_header">EXPIRES</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<td class="csui"><%=r.getString("PATTERN_ID") %></td>
								<td class="csui"><%=r.getString("ISDOT") %></td>
								<td class="csui"><%=r.getString("EXPIRES") %></td>
