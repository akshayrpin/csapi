...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getProjectStatus(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getProjectStatus(map),table);
		 }
...
<div id="csuibody">
		<div id="csuimain">
			...
			<div class="csuicontent">
				...
				<form id="csform"  action="add.jsp" method="post" enctype="multipart/form-data">
