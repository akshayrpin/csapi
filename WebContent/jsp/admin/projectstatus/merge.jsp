...
<%
	...
	String updateTable=Table.PROJECTTABLE;
	String alert="";
	 JSONArray pstatus = AdminAgent.getLookup(table);
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<select  name="STATUS_ID" id="STATUS_ID" itype="String" val="" _ent="lso" valrequired="true" ><option value=""></option>
									...
									{
										String idM=pstatus.getJSONObject(i).getInt("ID")+"";
									...
									if(!idMatch)
									{
										System.out.println(pstatus.getJSONObject(i).getString("TEXT"));
									%>	<option value="<%=pstatus.getJSONObject(i).getInt("ID")%>"><%=pstatus.getJSONObject(i).getString("TEXT")%></option>		<%}}%>
