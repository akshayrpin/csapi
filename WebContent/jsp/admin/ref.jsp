...
<%
	...
	ArrayList<MapSet> subm = AdminAgent.getSubModule(type, typeid, id);
	...
	StringBuffer urlsort = new StringBuffer();
	 ...
	 if(map.equalsIgnoreCase("SEARCH","SEARCH")){
		...
		a =  AdminAgent.getRefList(map,start,end,sortfield,order,map.getString("SQ"),map.getString("SEARCH_FIELDS")); 
		//records =5;
	...
	<div id="csuicontrols">
		<div id="csuicontrol" class="csuicontrol warning">
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr>
					<td align="left" class="csuicontrol"><%="REF " + l.getString("NAME")%></td>
					<td align="right">
	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<br/><br/>
				...
				<form id="csform" action="<%=Config.fullcontexturl()%>/jsp/admin/ref.jsp" method="post">
				<input type="hidden" name="_ent" value="<%=ent%>">
				<input type="hidden" name="_type" value="<%=type%>">
				<input type="hidden" name="_typeid" value="<%=typeid%>">
				<input type="hidden" name="_id" value="<%=id%>">
				<input type="hidden" name="ID" value="<%=map.getString("ID")%>">
				...
				<%
				for(int m=0;m<subm.size();m++){
					MapSet mp = subm.get(m);
				%>
				<div class="csui_divider"></div>
				   <table class="csui_title" alert="warning">
						<tr>
						<td class="csui_title"><%= " REF "+mp.getString("NAME") +" " +l.getString("NAME") %></td>
						</tr>
					</table>
						...
						<tr>
							...
							<td class="csui_header"><%=mp.getString("NAME") +" "%></td>
						...
						<%for(int i=0;i<a.size();i++){
							...
							if(r.getString("MODULE_NAME").equalsIgnoreCase(mp.getString("NAME"))){
						%>
