...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getResolutionStatus(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getResolutionStatus(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">RESOLUTION STATUS</td>
				...
				<form id="csform" action="add.jsp" method="post">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">RESOLUTION STATUS</td>
