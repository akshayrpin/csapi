...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		     MapSet ms = AdminMap.getReviewGroupMulti(map);
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<select  name="AUTO_ADD" id="AUTO_ADD" itype="String" val="" _ent="lso" valrequired="true" >
								...
								<select  name="INSPECTION" id="INSPECTION" itype="String" val="" _ent="lso" valrequired="true" >
										<option value="">Please Select</option>
										<option value="Y">Yes</option>
										<option value="N">No</option>
									</select>
