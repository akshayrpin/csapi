...
<%
	...
	String updateTable=Table.REFCOMBOREVIEWACTIONTABLE;
	String alert="";
	int editId = map.getInt("_editid");
	JSONArray rstatus = AdminAgent.getLookup(table,editId);
	...
	if(map.equalsIgnoreCase("_action","MERGE")){
		 System.out.println("Test123");
		 MapSet ms = AdminMap.mergeStatus(map);
		 result = AdminAgent.mergeStatus(ms,table,updateTable);
	 }
...
<div id="csuibody">
		<div id="csuimain">
			...
			<div class="csuicontent">
				...
				<form id="csform" class="form" ajax="no" action="merge.jsp" method="post">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">PROJECT STATUS MERGE</td>
						...
						<table class="csui" colnum="2" type="default">
							<tr>
						     	<td class="csui_label" colnum="2" alert="">PROJECT STATUS</td>
								<td class="csui" colnum="2" type="String" itype="String" alert="" >
								<select  name="STATUS_ID" id="STATUS_ID" itype="String" val="" _ent="lso" valrequired="true" ><option value=""></option>
									...
									{
										String idM=rstatus.getJSONObject(i).getInt("ID")+"";
									  if((idM).equalsIgnoreCase(idArray[j]))
									  {
										  System.out.println(idArray[j]  + " "+idM );
										 idMatch=true; 
									  }
									}
									if(!idMatch)
									{
										System.out.println(rstatus.getJSONObject(i).getString("TEXT"));
									%>	<option value="<%=rstatus.getJSONObject(i).getInt("ID")%>"><%=rstatus.getJSONObject(i).getString("TEXT")%></option>		<%}}%>
			...
			<div class="csui_buttons">
				...
				<input type="submit" name="_action" value="merge" class="csui_button">
			</div>
				</form>
			</div>
		</div>
