...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 MapSet e = AdminMap.getReviewStatus(map);
		 
		 if(e.getString("DEFLT").equals("Y")){
			 result = AdminAgent.saveType("UPDATE LKUP_REVIEW_STATUS SET DEFLT ='N' WHERE LKUP_REVIEW_TYPE_ID = "+e.getInt("LKUP_REVIEW_TYPE_ID"));
		 }
		 
		 if(e.getString("SCHEDULE_CANCEL").equals("Y")){
			 result = AdminAgent.saveType("UPDATE LKUP_REVIEW_STATUS SET SCHEDULE_CANCEL ='N' WHERE LKUP_REVIEW_TYPE_ID = "+e.getInt("LKUP_REVIEW_TYPE_ID"));
		 }
		 if(e.getString("SCHEDULE_INSPECTION_CANCEL").equals("Y")){
			 result = AdminAgent.saveType("UPDATE LKUP_REVIEW_STATUS SET SCHEDULE_INSPECTION_CANCEL ='N' WHERE LKUP_REVIEW_TYPE_ID = "+e.getInt("LKUP_REVIEW_TYPE_ID"));
		 }
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<input name="LKUP_REVIEW_TYPE_ID" type="hidden" value="<%= reviewTypeId%>" >
								<%=reviewTypeName%>
								</td>
