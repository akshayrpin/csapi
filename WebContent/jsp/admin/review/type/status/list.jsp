					...
					<table class="csui tablesorter" type="horizontal">
					 <thead>
						<tr>
							...
							<td class="csui_header">APPROVED</td>
							<td class="csui_header">UNAPPROVED</td>
							<td class="csui_header">ASSIGN</td>
							<td class="csui_header">FINAL</td>
							<td class="csui_header">SCHEDULE</td>
							<td class="csui_header">SCHEDULE CANCEL</td>
							<td class="csui_header">ATTACHMENT</td>
							<td class="csui_header">PDOX</td>
						<!--	<td class="csui_header">REVIEW TYPE</td>-->
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<td class="csui"><%=r.getString("STATUS") %></td>
								<td class="csui"><%=r.getString("DESCRIPTION") %></td>
								<td class="csui"><%=r.getString("APPROVED") %></td>
								<td class="csui"><%=r.getString("UNAPPROVED") %></td>
								<td class="csui"><%=r.getString("ASSIGN") %></td>
								<td class="csui"><%=r.getString("FINAL") %></td>
								<td class="csui"><%=r.getString("SCHEDULE") %></td>
								<td class="csui"><%=r.getString("SCHEDULE_CANCEL") %></td>
								<td class="csui"><%=r.getString("ATTACHMENT") %></td>
								<td class="csui"><%=r.getString("PDOX") %></td>
								<!--	<td class="csui"><%=r.getString("LKUP_REVIEW_TYPE_ID") %></td>-->
