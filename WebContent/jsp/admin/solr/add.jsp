...
<%
	...
	String table = Table.LKUPSOLRURLTABLE;
	String alert="";
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">SOLR INDEXING ADMIN</td>
				...
				<form id="csform" action="add.jsp" method="post">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">SOLR ADMIN</td>
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								<td class="csui_label" colnum="2" alert="">PACKAGE NAME</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="TYPE" type="text" itype="text" value="<%=v.getString("PACKAGE_NAME") %>" valrequired="true" maxchar="10000"></td>
								<td class="csui_label" colnum="2" alert="">PACKAGE URL</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="DESCRIPTION" type="text" itype="text" value="<%=v.getString("PACKAGE_IMPORT_URL") %>" valrequired="false" maxchar="10000"></td>
							</tr>
							
							<tr>
								<td class="csui_label" colnum="2" alert="">TYPE</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="TYPE" type="text" itype="text" value="<%=v.getString("PACKAGE_STATUS_URL") %>" valrequired="true" maxchar="10000"></td>
							     <td class="csui_label" colnum="2" alert="">ISDOT</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert="" ><div><input name="ACTIVE" type="checkbox"  <%if(v.getString("ACTIVE").equals("Y")){ %>checked <% }%>itype="boolean" ></div></td>
							</tr>
							<tr>
