					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="PATTERN" type="text" itype="text" value="<%=v.getString("PATTERN") %>" valrequired="true" maxchar="10000"></td>
							...
							<tr>
								<td class="csui_label" colnum="2" alert="">CONFIGURATION GROUP ID</td>
								<td class="csui" colnum="2" type="DATE" itype="DATE" alert=""><input name="CONFIGURATION_GROUP_ID" type="text" itype="String" value="<%=v.getString("CONFIGURATION_GROUP_ID") %>" valrequired="true" maxchar="10000"></td>
