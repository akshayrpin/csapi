...
<%
	...
	String sortfield= map.getString("SORT_FIELD","ID");
...
<div id="loader"></div>
  ...
  <tr>
	<td class="csui_tools">
		<a  href="../user/user/user.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>&ID=0&process=add" ><img src="/cs/images/icons/controls/white/add.png" border="0"></a>
	</td>
	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<br/><br/>
				...
				<input type="hidden" name="SEARCH_FIELDS" value="FIRST_NAME,MI,LAST_NAME,USERNAME,EMAIL">
					...
					<table class="csui tablesorter" type="horizontal">
					 <thead>
						<tr>
							...
							-->
							<td class="csui_header">FIRST_NAME</td>
							<td class="csui_header">MI</td>
							<td class="csui_header">LAST_NAME</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<a target="lightbox-iframe" href="../user/user/user.jsp?_ent=<%=ent%>&_id=<%=id%>&_type=<%=type%>&_typeid=<%=typeid%>&ID=<%=r.getString("ID") %>&process=edit" ><img src="/cs/images/icons/controls/black/edit.png" border="0"></a>
								</td>
