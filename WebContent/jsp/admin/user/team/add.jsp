...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getTeamType(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getTeamType(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">TEAM</td>
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert="" colspan="4"><input name="TYPE" type="text" itype="text" value="<%=v.getString("TYPE") %>" valrequired="true" maxchar="10000"></td>
							</tr>
							<tr>
