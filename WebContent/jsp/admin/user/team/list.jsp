...
<%
	...
	String table = Table.LKUPTEAMTYPETABLE;
	...
	<div id="csuibody">
		<div id="csuimain">
			...
			<br/><br/>
				...
				<input type="hidden" name="SEARCH_FIELDS" value="TYPE">
				   ...
				   <table class="csui_title" alert="warning">
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<%} %>
								<td class="csui" style="cursor:pointer;" rel="<%=r.getString("ID") %>" ><%=r.getString("TYPE") %>
								 <input type="hidden" id="refname_<%=r.getString("ID") %>" name="refname_<%=r.getString("ID") %>" value="<%=r.getString("TYPE") %>">
