...
<%
	...
	String table = Table.LKUPUSERTYPETABLE;
	String alert="";
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 if(editId>0){
			 result = AdminAgent.updateType(AdminMap.getUserType(map),table);
		 }else {
			 result = AdminAgent.saveType(AdminMap.getUserType(map),table);
		 }
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">USER TYPE</td>
						<td align="right" id="subtitle">&nbsp;</td>
					</tr>
				</table>
				
				<div id="csform_message"></div>
				<form id="csform" action="add.jsp" method="post" class="form"  ajax="no" >
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">USER TYPE</td>
						...
						<table class="csui" colnum="2" type="default">
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="DESCRIPTION" type="text" itype="text" value="<%=v.getString("DESCRIPTION") %>" valrequired="false" maxchar="10000"></td>
							</tr>
							
							<tr>
								<td class="csui_label" colnum="2" alert="">REQUIRED LICENSE</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="REQUIRED_LICENSE" type="checkbox" itype="boolean" <%if(v.getString("REQUIRED_LICENSE").equals("Y")){ %>checked <% }%> ></div></td>
						        <td class="csui_label" colnum="2" alert="">APPLICANT</td>
								<td class="csui" colnum="2" type="boolean" itype="boolean" alert=""><div><input name="APPLICANT" type="checkbox" itype="boolean" <%if(v.getString("APPLICANT").equals("Y")){ %>checked <% }%> ></div></td>
							...
							<tr>
								...
								<td class="csui_label" colnum="2" alert="">VALIDATE LICENSE URL</td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" ><input name="VALIDATE_LICENSE_URL" type="text" itype="text" value="<%=v.getString("VALIDATE_LICENSE_URL") %>" valrequired="false" maxchar="10000"></td>
