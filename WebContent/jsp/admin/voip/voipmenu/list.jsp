					...
					<table class="csui tablesorter" type="horizontal">
					 <thead>
						<tr>
							...
							-->
							<td class="csui_header">PRESS</td>
							<td class="csui_header">DESCRIPTION</td>
							<td class="csui_header">LOGIC</td>
							<td class="csui_header">HINT</td>
							<td class="csui_header">SAY DESCRIPTION</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								<td class="csui"><%=r.getString("PRESS") %></td>
								<td class="csui"><%=r.getString("DESCRIPTION") %></td>
								<td class="csui"><%=r.getString("LOGIC") %></td>
								<td class="csui"><%=r.getString("HINT") %></td>
								<td class="csui"><%=r.getString("SAY_DESCRIPTION") %></td>
								<td class="csui"><%=r.getString("ACTIVE") %></td>
