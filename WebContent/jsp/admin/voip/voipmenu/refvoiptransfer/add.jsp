...
<%
	...
	String table = Table.REFVOIPTRANSFERTABLE; 
	String alert="";
	...
	String voipmenuName = map.getString("_voipmenuname","");
	String voipmenuId = map.getString("_voipmenuid","0");
	String press = map.getString("_press","0");
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 MapSet e = AdminMap.getRefVoipTransfer(map);
	 ...
	 JSONArray types = AdminAgent.getLookup("LKUP_VOIP_MENU");
	...
	<script>
		$(document).ready(function() {
			...
			<% if(editId>0){%>
				...
				$('#LKUP_VOIP_MENU_ID').val(<%=v.getString("LKUP_VOIP_MENU_ID")%>);
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">TRANSFER</td>
				...
				<form id="csform" class="form" ajax="no"  action="add.jsp" method="post">
					...
					<input type="hidden" name="_voipmenuname" value="<%=voipmenuName%>">
					<input type="hidden" name="_voipmenuId" value="<%=voipmenuId%>">
					
					<table class="csui_title">
						<tr>
							<td class="csui_title">TRANSFER</td>
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<td class="csui" colnum="2" type="String" itype="text" alert="" colspan="4">
									<input name="LKUP_VOIP_MENU_ID" type="hidden" value="<%=voipmenuId%>" >
								<%=voipmenuName%>
								</td>
							</tr>
							...
							<tr>	
								...
								<td class="csui" colnum="2" type="String" itype="text" alert="">
									<input name="PRESS" type="text" itype="text" value="<%=v.getString("PRESS") %>" maxchar="10000" valrequired="true">
								</td>
								
								<td class="csui_label" colnum="2" alert="">PHONE</td>
								<td class="csui" colnum="2" type="String" itype="text" alert=""><input name="PHONE" type="text" itype="text" value="<%=v.getString("PHONE") %>" maxchar="10000" valrequired="true"></td>
							</tr>
							
							<tr>
								<td class="csui_label" colnum="2" alert="">DESCRIPTION</td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" colspan="4">
									<textarea name="DESCRIPTION"><%=v.getString("DESCRIPTION") %></textarea>
								</td>
							</tr>	
							
							<tr>
								<td class="csui_label" colnum="2" alert="">HINT</td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" colspan="4"><input name="HINT" type="text" itype="text" value="<%=v.getString("HINT") %>" maxchar="10000"></td>
