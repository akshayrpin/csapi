					...
					<table class="csui tablesorter" type="horizontal">
					 <thead>
						<tr>
							...
							<td class="csui_header">CLOSED</td>
							<td class="csui_header">GLOBAL HOLIDAY</td>
						...
						%>
							<tr id="tr_<%=r.getString("ID") %>">
								...
								<td class="csui"><%=r.getString("CLOSED") %></td>
								<td class="csui"><%=r.getString("GLOBAL_HOLIDAY") %></td>
