...
<%
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 MapSet notify =Notify.getOptions(map);
	...
	from.addDay(v.getInt("NO_OF_DAYS"));
	Timekeeper to = new Timekeeper();
	to.addDay(v.getInt("NO_OF_DAYS_TO"));
%>
<html>
<head>
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">NOTIFY</td>
						<td align="right" id="subtitle">&nbsp;</td>
					</tr>
				</table>
				
				<div id="csform_message"></div>
				<form id="csform" class="form" ajax="no" action="notify.jsp" method="post">
					...
					<table class="csui_title">
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<td class="csui" colnum="2" type="date" itype="date" alert="" valrequired="true" colspan="3">
							...
							<tr>
								...
								<td class="csui_label" colnum="2" alert="">FROM DAYS (+/- 10)<font color="red">*</font></td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" nowrap>
									<input name="NO_OF_DAYS" type="text" itype="text" value="<%=v.getString("NO_OF_DAYS") %>" valrequired="false" maxchar="10000" class="dtsel" div="from">
									<div id="from" style="color:tomato;" ><%=from.getString("MM/DD/YYYY") %></div>
								</td>
								
								<td class="csui_label" colnum="2" alert="">TO DAYS (+/- 10) <font color="red">*</font></td>
								<td class="csui" colnum="2" type="String" itype="text" alert="" nowrap>
									<input name="NO_OF_DAYS_TO" type="text" itype="text" value="<%=v.getString("NO_OF_DAYS_TO") %>" valrequired="false" maxchar="10000" class="dtsel" div="to"> 
									<div id="to" style="color:tomato;"><%=to.getString("MM/DD/YYYY") %></div>
								</td>
							</tr>
							...
							<tr>
								<td class="csui_label" colnum="2" alert="">NOT IN STATUS<font color="red">*</font></td>
								<td class="csui" colnum="2" type="date" itype="date" alert="" colspan="3">
