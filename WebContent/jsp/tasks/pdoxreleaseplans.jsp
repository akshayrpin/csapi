...
<%
	...
	String table = "TASKS_PDOX_RELEASE_PLAN";
	...
	boolean result = false;
	 if(map.equalsIgnoreCase("_action","SAVE")){
		 MapSet payment =PDoxReleasePlans.getOptions(map);
		...
		<div id="csuimain">
			...
			<div class="csuicontent">
				<table cellpadding="10" cellspacing="0" border="0" width="100%">
					<tr>
						<td align="left" id="title">PDOX RELEASE PLAN</td>
						<td align="right" id="subtitle">&nbsp;</td>
					</tr>
				</table>
				
				<div id="csform_message"></div>
				<form id="csform" class="form" ajax="no" action="pdoxreleaseplans.jsp" method="post">
					<input type="hidden" name="_type" value="<%=type%>">
					<input type="hidden" name="_typeid" value="<%=typeid%>">
					<input type="hidden" name="LKUP_ACT_TYPE_ID" value="<%=lkup_id%>">
					<input type="hidden" name="TASK" value="PDoxReleasePlans">
					...
					<table class="csui_title">
						<tr>
							<td class="csui_title">PDOX RELEASE PLAN</td>
						...
						<table class="csui" colnum="2" type="default">
							...
							<tr>
								...
								<input name="TEMPLATE_ATTACHMENT" id="TEMPLATE_ATTACHMENT" type="checkbox"  itype="boolean" <%if(v.getString("TEMPLATE_ATTACHMENT").equals("Y")){ %>checked <% }%> ></div></td>
